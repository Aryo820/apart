                        ...
                        <li class="border border-white/10 bg-ink-900 transition-colors hover:border-gold-400/30">
                            <article class="flex flex-col gap-6 p-5 sm:p-6 lg:flex-row lg:items-center lg:justify-between">
                                <div class="flex min-w-0 items-start gap-5">
                                    ...
                                    >
                                    <div class="min-w-0">
                                        <p class="font-mono text-xs font-bold tracking-[0.08em] text-gold-400">{{ $booking->booking_code }}</p>
                                        ...
                                        <p class="mt-1 truncate text-xs font-bold uppercase tracking-[0.14em] text-ink-400">
                                            {{ $booking->apartment->city }} · {{ $booking->apartment->address }}
                                        </p>

                                        <dl class="mt-4 flex flex-wrap gap-x-8 gap-y-3">
                                            <div>
                                                <dt class="text-xs font-bold uppercase tracking-[0.14em] text-ink-400">Check-in</dt>
                                                <dd class="mt-1 text-sm text-ivory-100">{{ $booking->check_in->format('d M Y') }}</dd>
                                            </div>
                                            <div>
                                                <dt class="text-xs font-bold uppercase tracking-[0.14em] text-ink-400">Check-out</dt>
                                                <dd class="mt-1 text-sm text-ivory-100">{{ $booking->check_out->format('d M Y') }}</dd>
                                            </div>
                                            <div>
                                                <dt class="text-xs font-bold uppercase tracking-[0.14em] text-ink-400">Durasi</dt>
                                ...
                                <div class="flex shrink-0 flex-col gap-4 border-t border-white/10 pt-5 lg:items-end lg:border-0 lg:pt-0">
                                    ...
                                    <div class="lg:text-right">
                                        <p class="text-xs font-bold uppercase tracking-[0.14em] text-ink-400">Total</p>
                                    ...
                                    @else
                                        <a href="{{ route('bookings.show', $booking->booking_code) }}" class="inline-flex min-h-11 w-full items-center justify-center border border-white/15 px-5 text-xs font-bold uppercase tracking-[0.1em] text-ink-200 transition-colors hover:border-gold-400/50 hover:text-white lg:w-auto">
                                            Lihat detail
                                        </a>
                                    @endif
                                </div>
